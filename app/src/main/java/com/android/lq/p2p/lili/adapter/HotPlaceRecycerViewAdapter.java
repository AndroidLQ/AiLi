...
public class HotPlaceRecycerViewAdapter extends BGARecyclerViewAdapter<InvestGirdModel> {
    private int itemWidth;
    public HotPlaceRecycerViewAdapter(RecyclerView recyclerView, int itemWidth) {
        super(recyclerView,R.layout.hot_place_item_layout);
